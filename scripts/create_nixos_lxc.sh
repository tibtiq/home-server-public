...
curl -fsSL https://raw.githubusercontent.com/tibtiq/home-server-public/refs/heads/13-setup-single-script-for-setting-up-nixos-lxc/scripts/create_nixos_lxc.sh | bash
